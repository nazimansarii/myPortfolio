    ...
    <>
      ...
      <section className="max-w-screen-xl mx-auto px-7 relative py-12 sm:pb-16 flex flex-wrap  justify-around space-y-30 sm:space-x-2  gap-4 font-[inherit]">
        ...
        >
          <div className=" text-center bg-black shadow-cyan-600 shadow-sm hover:shadow-md flex flex-col items-center relative group hover:scale-105 ease-in-out sm:mr-auto duration-200  px-3 py-5 rounded-md">
            ...
            <div className="mt-6 max-w-[350px] w-full">
              ...
              <p className="text-md my-1 font-extrabold border-b-2  rounded-md text-amber-600 py-1">
                A tailor shop platform
              </p>
        ...
        >
          <div className=" text-center bg-black shadow-cyan-600 shadow-sm hover:shadow-md flex flex-col items-center relative group hover:scale-105 ease-in-out sm:mr-auto duration-200  px-3 py-5 rounded-md">
            ...
            <div className="mt-6 max-w-[350px] w-full">
              ...
              <p className="text-md my-1 font-extrabold border-b-2  rounded-md text-emerald-600 py-1 ">
                An Expense Tracker platform
              </p>
              <p className="text-justify">
        ...
        >
          <div className=" text-center bg-black shadow-cyan-600 shadow-sm hover:shadow-md flex flex-col items-center relative group hover:scale-105 ease-in-out sm:mr-auto duration-200  px-3 py-5 rounded-md">
            <Link
              to="https://countrya-pi.netlify.app/"
              target="_black"
              className="flex flex-col items-center justify-center"
            >
              <img
              ...
              <span className="flex group-hover:-top-14  ease-jump duration-200 bg-[#00b4d8] sm:absolute left-1/2 sm:-translate-x-1/2 top-5 px-2 py-1 text-sm sm:text-base mt-2 rounded w-max items-center gap-1 after:hidden sm:after:block after:w-4 after:h-4 after:bg-inherit after:absolute after:left-1/2 after:-translate-x-1/2 after:rotate-45 after:-bottom-2">
                Rest Countries
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
            ...
            <div className="mt-6 max-w-[350px] w-full">
              <h4 className="text-center text-2xl text-[#00b4d8] font-bold border-t-2 rounded-md  pt-1">
                Rest Countries
              </h4>
              <p className="text-md my-1 font-extrabold border-b-2  rounded-md text-[#2DAA9E] py-1 ">
                A platform to explore country details
              </p>
              <p className="text-justify">
              ...
              <ul className="flex justify-evenly items-center my-3 flex-wrap gap-2">
                ...
                <li className="border rounded-md px-4 py-1">#JavaScript</li>
                <li className="border rounded-md px-4 py-1">#ReactJS</li>
                <li className="border rounded-md px-4 py-1">#API</li>
              </ul>
              <Link
                to="https://github.com/nazimansarii/rest-country"
                target="_blank"
              >
                <button className="w-full bg-[#1788ae]  cursor-pointer mt-4 hover:scale-105 duration-300 py-2 rounded-md flex items-center justify-center">
                  GitHub
